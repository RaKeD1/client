...
export const loginAccount = createAsyncThunk<AxiosResponse<AuthResponse>, loginParams>(
    ...
    async (params, { rejectWithValue }) => {
      ...
      try {
        ...
        return response;
      } catch (error:any) {//todo исправить тип с any на другой
        console.log(error);
        if (!error.response) {
...
export const user = accountSlice.actions.accountFetchingSuccess;
